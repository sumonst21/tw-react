...
import OpenSrc from '../img/tw-opensrc-logo.svg';
				...
				<HeroOverlay>
					<HeroContainer className={'row valign-wrapper'}>
						<HeroContent className={'col m12'}>
							...
							<div>
								<HeroTitle>
									<TypeWriterText strings={'developer();'} speed={100} />
									<div id={'type-it'} />
								</HeroTitle>
							</div>
							<Button
							...
							<CreatorSection>
								<h5>CREATOR OF:</h5>
								<div>
									<a href={'https://opensrc.io'} target={'_blank'}>
										<HomepageLogo src={OpenSrc} alt={'OpenSrc Logo'} />
									</a>
								</div>
								<div>
